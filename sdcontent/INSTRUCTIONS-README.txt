...
2. Format the SD card using hte platform-specific instructions below:
   a. Windows
...
If you are still having difficulties after following these instructions, then please visit the Raspberry Pi Forum for support (http://www.raspberrypi.org/phpBB3).
